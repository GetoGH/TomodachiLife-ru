...
> [!NOTE]
> 
> Обновление драйверов видеокарты может помочь при графических багах

## Как узнать какая у вас видеокарта

Пкм по значку меню пуск, откройте диспетчер устройств.



<img src="./_index.png" crop="0,0,100,100" scale="35" objects="square,37.3894,90.6977,22.3451,9.3023,,top-left&square,3.5398,20.6718,45.354,6.8475,,top-left" width="452px" height="774px" float="center"/>

В разделе **видеоадаптеры** написана модель вашей видеокарты

<img src="./_index-2.png" crop="0,0,100,100" scale="64" objects="square,2.7616,45.2229,41.2791,11.465,,top-left" width="688px" height="471px" float="center"/>
